...
export function drawEyes(eyeType, char, animFrame, drawRect) {
  ...
  switch (eyeType) {
    ...
    case 'sparkle':
      drawRect(leftX, eyeY, 6, 6, COLOR_EYE);
      drawRect(rightX, eyeY, 6, 6, COLOR_EYE);
      drawSparkle(50, 8, animFrame, drawRect);
      break;
    ...
    case 'sleep':
      drawRect(leftX, eyeY + 2, 6, 2, COLOR_EYE);
      drawRect(rightX, eyeY + 2, 6, 2, COLOR_EYE);
      drawZzz(50, 6, animFrame, drawRect);
      break;
  }
}

// Draw sparkle (scaled 2x)
export function drawSparkle(x, y, animFrame, drawRect) {
...
export function drawZzz(x, y, animFrame, drawRect) {
  const frame = animFrame % 20;
  if (frame < 10) {
    drawRect(x, y, 6, 1, COLOR_WHITE);
    drawRect(x + 4, y + 1, 2, 1, COLOR_WHITE);
    drawRect(x + 3, y + 2, 2, 1, COLOR_WHITE);
    drawRect(x + 2, y + 3, 2, 1, COLOR_WHITE);
    drawRect(x + 1, y + 4, 2, 1, COLOR_WHITE);
    drawRect(x, y + 5, 6, 1, COLOR_WHITE);
  }
}
